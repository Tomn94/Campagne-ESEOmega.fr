...
<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="http://176.32.230.7/eseomega.com/blog/wp-content/uploads/2015/05/logo.png" id="logoESEOmega" height="<?php echo get_custom_header()->height/2; ?>" width="<?php echo get_custom_header()->width/2; ?>" alt="<?php bloginfo( 'name' ); ?>"/></a>
